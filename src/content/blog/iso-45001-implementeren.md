---
title: 'ISO 45001 implementeren: arbobeheersysteem stap voor stap'
description: 'Het volledige implementatieproces voor ISO 45001 — van gevaaridentificatie tot certificering.'
publishDate: 2026-05-22
category: 'ISO 45001'
readTime: '7 min'
author: 'Control One Redactie'
image: '/blog/banner-iso45001.svg'
imageAlt: 'ISO 45001 implementeren: arbobeheersysteem stap voor stap — Control One'
keywords:
  - ISO 45001 implementeren
  - arbobeheersysteem opzetten
...
| Onderwerp | Wat wordt beoordeeld | Resultaat |
|---|---|---|
| Beleidsverklaring | Bestaat er een formeel arbobeleid? | Aanwezig / ontbreekt / moet worden aangepast |
| Gevaaridentificatie | Is er een systematische RI&E? | Actueel / verouderd / ontbreekt |
| Risicobeheersing | Zijn er procedures voor gevaarlijke taken? | Volledig / gedeeltelijk / ontbreekt |
| Doelstellingen | Worden arbodoelstellingen gemeten? | Ja / nee |
...
## Fase 3: implementatie en bewustwording

Een systeem op papier is geen garantie voor veilig gedrag in de praktijk. De implementatiefase richt zich op het verankeren van het systeem in de dagelijkse werkpraktijk.
...
**Moeten medewerkers instemmen met het OH&S-systeem?**
ISO 45001 vereist actieve participatie van medewerkers, maar geen formele instemming in de zin van de Wet op de ondernemingsraden. Wel heeft de OR instemmingsrecht op arbeidsomstandighedenbeleid.

**Kan ISO 45001 worden gecombineerd met ISO 9001 of ISO 14001?**
Ja, alle drie de normen delen de High Level Structure (HLS). Een geïntegreerd managementsysteem is efficiënter en vermindert de auditlast aanzienlijk.
