...
keywords:
  ...
  - 'ESG milieucertificering'
  - 'ISO 14001 non-financiële rapportage'
draft: false
---

ESG — Environmental, Social en Governance — is in korte tijd uitgegroeid van een nicheterm tot een kernthema in de bedrijfsstrategie van vrijwel elk serieus bedrijf. Aandeelhouders, banken, grote afnemers en overheden vragen steeds nadrukkelijker om inzicht in de milieu- en maatschappelijke prestaties van organisaties. ISO 14001 blijkt daarin een onmisbare schakel: het systeem levert de gestructureerde data en de bewezen methodiek die ESG-rapportage geloofwaardig maakt.

## Wat is ESG en waarom is het relevant voor het MKB?

ESG staat voor de drie pijlers van duurzaam ondernemen:
- **Environmental (Milieu)**: CO₂-uitstoot, energieverbruik, watergebruik, afval, biodiversiteit
...
Het milieupijler van ESG omvat precies de thema's die ISO 14001 systematisch beheert:

- Broeikasgasemissies (scope 1, 2 en deels 3)
...
## Koppeling van ISO 14001 en ESG: wat vraagt dit operationeel?

| ISO 14001-element | ESG-toepassing |
|---|---|
| Milieuaspectenanalyse | Basis voor materialiteitsanalyse (welke milieuthema's zijn wezenlijk?) |
| Milieudoelstellingen | ESG-targets en reductiedoelstellingen |
| Prestatiemonitoring (clausule 9.1) | Dataverzameling voor ESG-rapportage |
| Interne audit | Verificatie van ESG-data integriteit |
| Managementreview | ESG-rapportage aan directie en bestuur |
| Continue verbetering | Voortgang op ESG-commitments |

## Wat ISO 14001 nog niet dekt

ISO 14001 is een krachtig fundament, maar dekt niet alle ESG-eisen. De sociale (S) en governance (G) pijlers vallen buiten de scope van de norm. Daarnaast vereist ESG-rapportage vaak:

- **Scope 3-emissies** — De ketenemissies die ISO 14001 slechts als indirecte milieuaspecten behandelt, maar waarvoor ESG doorgaans gedetailleerdere data vraagt
- **Biodiversiteitsimpact** — Toenemend relevant voor CSRD, maar nog niet systematisch in ISO 14001 verankerd
- **Sociale KPI's** — Ziekteverzuim, diversiteit, loongelijkheid: niet gedekt door ISO 14001 maar wel door ISO 45001 en HR-processen
