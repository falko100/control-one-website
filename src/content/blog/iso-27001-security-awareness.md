...
imageAlt: 'Security awareness training voor ISO 27001 — Control One'
keywords:
  - 'security awareness ISO 27001'
  - 'bewustwording informatiebeveiliging'
  - 'phishing training medewerkers'
  - 'Annex A 6.3'
draft: false
---
...
1. **Jaarlijkse basistraining** voor alle medewerkers (phishing, wachtwoorden, beleid, melden)
2. **Kwartaalse microlearning** via e-mail of intranet (actuele dreigingen, specifieke scenario's)
3. **Phishing-simulaties** twee tot vier keer per jaar
