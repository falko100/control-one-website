...
imageAlt: 'High Level Structure: de basis van alle ISO-normen — Control One'
keywords:
  - High Level Structure ISO
  - HLS ISO normen
  - geïntegreerd managementsysteem HLS
  - Annex SL ISO
draft: false
---
...
De **High Level Structure** is een gestandaardiseerde opbouw die ISO voorschrijft voor alle nieuwe en herziene managementsysteemnormen. Het idee is eenvoudig: door alle normen dezelfde structuur, dezelfde kernclausules en dezelfde definities te geven, worden ze **combineerbaar en beheerbaar**.

### Waarom is de HLS ingevoerd?

Vóór de invoering van de HLS had elke ISO-norm een eigen structuur, eigen terminologie en eigen logica. Organisaties die zowel [ISO 9001](/iso-9001) als [ISO 27001](/iso-27001) wilden implementeren, moesten twee volledig verschillende systemen naast elkaar beheren. Dat leidde tot dubbel werk, tegenstrijdige documenten en verwarring bij medewerkers.

Met de HLS heeft ISO dit probleem opgelost. Alle normen delen nu:

- Dezelfde tien hoofdstukken (clausules 1 tot en met 10)
- Dezelfde kernbegrippen en definities
- Dezelfde vereisten rondom leiderschap, planning en verbetering

### De relatie met Annex SL

De term **Annex SL** verwijst naar het document binnen ISO/IEC-richtlijnen dat de HLS formeel vastlegt. Technisch gezien is Annex SL inmiddels vervangen door Annex L in de meest recente editie van de ISO/IEC-richtlijnen, maar in de praktijk worden Annex SL en HLS nog steeds door elkaar gebruikt.

## De tien clausules van de HLS

Elke ISO-norm op basis van de HLS heeft exact dezelfde tien hoofdstukken. De invulling per norm verschilt, maar de structuur is identiek.

| Clausule | Onderwerp | Kernvraag |
|---|---|---|
| 1 | Toepassingsgebied | Waar is de norm op van toepassing? |
| 2 | Normatieve verwijzingen | Welke andere normen zijn van belang? |
| 3 | Termen en definities | Wat betekenen de kernbegrippen? |
| 4 | Context van de organisatie | Wie zijn wij en welke context werken wij in? |
| 5 | Leiderschap | Hoe is de directie betrokken? |
| 6 | Planning | Hoe beheersen wij risico's en kansen? |
| 7 | Ondersteuning | Welke middelen, competenties en communicatie zijn nodig? |
| 8 | Uitvoering | Hoe voeren wij onze processen uit? |
| 9 | Evaluatie van prestaties | Hoe meten en beoordelen wij onze resultaten? |
| 10 | Verbetering | Hoe leren en verbeteren wij systematisch? |

De clausules 1 tot en met 3 zijn informatief van aard. De echte eisen beginnen bij clausule 4.

## Welke normen gebruiken de HLS?

De meeste moderne ISO-managementsysteemnormen zijn inmiddels gebaseerd op de HLS. De belangrijkste voor het Nederlandse MKB:

### ISO 9001 — kwaliteitsmanagement

[ISO 9001](/iso-9001) is in 2015 herzien en volledig afgestemd op de HLS. Deze norm focust op klanttevredenheid, proceskwaliteit en continue verbetering.

### ISO 27001 — informatiebeveiliging

[ISO 27001](/iso-27001) volgt de HLS-structuur en voegt daar een uitgebreide bijlage aan toe met **93 beheersmaatregelen** (controls) voor informatiebeveiliging. De herziene versie uit 2022 maakt de norm nog beter combineerbaar met andere normen.

### ISO 14001 — milieumanagement

ISO 14001 richt zich op milieuprestaties en duurzaamheidsverplichtingen. Door de HLS-structuur is combinatie met ISO 9001 een populaire keuze.
...
Veel documenten zijn generiek genoeg om voor meerdere normen te gelden. Denk aan:

- Het beleidsstatement (clausule 5.2 in alle normen)
- De context-analyse (clausule 4.1 en 4.2)
- De risico-inventarisatie (clausule 6.1)
