...
description: "De Statement of Applicability is het hart van uw ISO 27001-implementatie. Zo vult u hem correct in."
...
De VvT — in het Engels de **Statement of Applicability (SoA)** — is het document waarin u voor elk van de 93 Annex A-controls van ISO 27001:2022 aangeeft of deze van toepassing is op uw organisatie, waarom, en in welke mate u deze geïmplementeerd heeft. In dit artikel leert u hoe u dit document stap voor stap correct invult.

## Wat is de Verklaring van Toepasselijkheid precies?

De VvT is verplicht gesteld in clausule 6.1.3d van ISO 27001. Het document dient als brug tussen uw risicoanalyse en uw daadwerkelijke beveiligingsmaatregelen. Het laat een auditor zien:

- Welke controls u heeft geselecteerd en waarom
- Welke controls u heeft uitgesloten en waarom
- In hoeverre de geselecteerde controls zijn geïmplementeerd

De VvT is daarmee ook een beheersinstrument: het geeft op één pagina (of één spreadsheet) inzicht in de volledige staat van uw informatiebeveiliging.

## De verplichte inhoud van de VvT

ISO 27001 stelt dat uw VvT minimaal het volgende moet bevatten:
...
## Stap 1: Begin met uw risicoanalyse

U kunt de VvT niet invullen zonder een [afgeronde risicoanalyse](/iso-27001). De controls die u in uw VvT opneemt, moeten namelijk afgeleid zijn van de risico's die u heeft geïdentificeerd. Dit is de logische volgorde:

1. Voer de risicoanalyse uit
2. Stel het risicobehandelplan op
3. Bepaal welke controls u nodig heeft om risico's te mitigeren
4. Neem deze controls op in de VvT

Controls die u opneemt om een andere reden dan risicomitigatie — bijvoorbeeld wettelijke verplichtingen of contractuele eisen van klanten — vermeldt u met die motivatie in de VvT.
...
Voor elke control neemt u een beslissing: van toepassing of niet. De meeste controls zullen voor MKB-organisaties van toepassing zijn. Uitzonderingen zijn er wel — denk aan control 7.4 (fysieke beveiligingsmonitoring) voor een volledig remote team zonder eigen kantoorruimte, of control 8.28 (veilige codering) voor een organisatie die zelf geen software ontwikkelt.

> **Tip:** Sla nooit controls over omdat ze lastig zijn om te implementeren. Uitsluiting is alleen geldig als een control écht niet relevant is voor uw organisatiecontext. Een auditor ziet direct wanneer uitsluitingen gemotiveerd zijn vanuit gemakzucht in plaats van context.

## Stap 3: Motiveer elk besluit

Voor elke control — of het nu gaat om opname of uitsluiting — documenteert u de motivatie. Goede motivatietypen zijn:
...
Een VvT is pas volledig als u ook bijhoudt in hoeverre elke geselecteerde control daadwerkelijk is geïmplementeerd. Gebruik een eenvoudige statusschaal:
...
Per control verwijst u naar het document, de procedure of de technische maatregel die aantoont dat de control is geïmplementeerd. Voorbeelden:

- Control 5.10 (Aanvaardbaar gebruik van informatie en andere activa) → Verwijzing naar uw Acceptable Use Policy
- Control 8.5 (Veilige authenticatie) → Verwijzing naar uw wachtwoordbeleid en MFA-configuratie
...
ISO 27001 vereist dit niet expliciet, maar auditoren zien een directiehandtekening graag als bewijs van management commitment. Het is een kleine moeite die u als professioneel overkomt.

---

De Verklaring van Toepasselijkheid is het document waarmee u aantoont dat uw ISMS doordacht en risicogebaseerd is ingericht. Met Control One genereert u een volledig ingevulde VvT op basis van uw risicoanalyse — klaar voor externe audit.

Bekijk onze [prijzen en pakketten](/prijzen) en start vandaag nog met uw ISO 27001-implementatie.
