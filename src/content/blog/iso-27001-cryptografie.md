...
description: "Encryptie, sleutelbeheer en cryptografisch beleid — wat eist ISO 27001 en hoe implementeer je het?"
...
## Encryptie in de praktijk: wat je minimaal moet regelen
...
> **Tip:** Controleer of je cloudproviders encryptie-at-rest standaard inschakelen of dat het een optie is die je zelf moet activeren. Bij Microsoft 365, Google Workspace en AWS is encryptie-at-rest standaard ingeschakeld. Bij kleinere providers is dit niet altijd het geval.

## Sleutelbeheer: het meest onderschatte onderdeel

Encryptie is alleen zo sterk als het beheer van de sleutels waarmee je versleutelt. Een versleuteld bestand is waardeloos als de sleutel verloren gaat — en een beveiligingslek als de sleutel in de verkeerde handen valt.

ISO 27001 vereist dat je beleid heeft voor de volledige levenscyclus van cryptografische sleutels. In de praktijk betekent dit voor MKB-organisaties:
...
**Intrekking en verwijdering.** Wanneer een medewerker de organisatie verlaat of wanneer een sleutel mogelijk gecompromitteerd is, moet je de sleutel kunnen intrekken. Documenteer dit proces.

## Algoritmen en sleutellengtes: welke keuzes zijn veilig?

ISO 27001 schrijft geen specifieke algoritmen voor, maar je bent verantwoordelijk voor het gebruik van cryptografische methoden die als veilig worden beschouwd op het moment van gebruik. De Nederlandse overheid volgt hierin de aanbevelingen van het NCSC en internationale organen zoals NIST.
...
Maak in je cryptografisch beleid een keuze voor de algoritmen en sleutellengtes die je organisatie gebruikt, gebaseerd op de actuele aanbevelingen van het NCSC of een vergelijkbare betrouwbare bron.

## Veelgestelde vragen

**Moet ik een aparte cryptograaf inhuren voor ISO 27001?**
Nee. ISO 27001 vereist cryptografisch beleid en sleutelbeheer, maar de uitvoering hoeft niet door een specialist te worden gedaan. De meeste moderne systemen (besturingssystemen, cloudplatformen, e-mailclients) bieden encryptie aan als ingebouwde functie die met beleid en configuratie kan worden ingeschakeld. Wat je nodig heeft, is iemand die begrijpt wanneer encryptie vereist is en die de systemen correct configureert.
...
Dit is een leveranciersrisico dat je moet adresseren in je leveranciersbeheer (Bijlage A 5.19–5.22). Als een leverancier verouderde protocollen gebruikt (zoals TLS 1.0 of onversleutelde verbindingen), documenteer je dit als risico en vraag je de leverancier om herstel. Weigert de leverancier dat, dan is dit reden voor een risicobeslissing: accepteer het risico met een mitigerende maatregel, of zoek een alternatieve leverancier.
