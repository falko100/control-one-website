---
title: 'ISO 27001 interne audit: zo voert je hem succesvol uit'
description: "Praktische gids voor het plannen, uitvoeren en rapporteren van de interne ISO 27001-audit."
publishDate: 2026-04-06
category: 'ISO 27001'
readTime: '7 min'
author: 'Control One Redactie'
image: '/blog/banner-iso27001.svg'
imageAlt: 'ISO 27001 interne audit — Control One'
keywords:
  - 'ISO 27001 interne audit'
  - 'auditprogramma ISMS'
  - 'audit checklist ISO 27001'
  - 'auditrapport informatiebeveiliging'
draft: false
---
...
**Auditplan opstellen**
Stel per auditdag een gedetailleerd auditplan op: welke clausules en controls worden onderzocht, welke medewerkers worden geïnterviewd, welke documenten worden bekeken.

**Auditchecklist samenstellen**
Een **auditchecklist** helpt de auditor om systematisch te werk te gaan. Maak per clausule en per relevante Annex A-control een lijst van vragen en te controleren bewijzen.

**Documenten verzamelen**
Zorg dat de auditor tijdig toegang heeft tot de relevante beleidsdocumenten, procedures, registraties en het risicobehandelplan.
...
**Hoe ver van tevoren voer ik de interne audit uit?**
Plan de interne audit minimaal 4 tot 8 weken vóór de externe (certificerings)audit. Zo heb je tijd om gevonden non-conformiteiten op te lossen voordat de externe auditor langskomt.

**Wat als er geen non-conformiteiten worden gevonden?**
Dat is onwaarschijnlijk bij een eerste interne audit, maar niet onmogelijk. Een externe auditor kan echter sceptisch zijn als er geen enkele bevinding is — het suggereert dat de audit niet grondig genoeg was. Observaties zijn altijd wel te vinden.

**Mag ik de interne audit uitstellen?**
Niet zonder risico. Als de externe auditor vaststelt dat je de interne audit niet op tijd heeft uitgevoerd, is dat zelf een non-conformiteit.
...
Ontdek hoe Control One je interne audit vereenvoudigt. Bekijk onze [prijzen en pakketten](/prijzen).
