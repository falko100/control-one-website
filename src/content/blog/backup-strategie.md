...
description: 'De 3-2-1 back-upregel is de gouden standaard tegen ransomware. Hoe implementeert u hem?'
...
Ransomware treft dagelijks organisaties wereldwijd. De aanvallers versleutelen uw bestanden en eisen losgeld voor de sleutel. De enige echte verdediging tegen ransomware is niet een betere firewall — het is een betrouwbare back-up die buiten het bereik van de aanvaller ligt. De 3-2-1 back-upregel is al tientallen jaren de gouden standaard voor gegevensherstel en is relevanter dan ooit. Toch implementeren veel organisaties hem onvolledig of incorrectly, waardoor ze ontdekken dat hun back-up waardeloos is op het moment dat ze hem het meest nodig hebben.

## De 3-2-1 regel: wat betekent hij precies?

De 3-2-1 regel is simpel in formulering, maar veeleisend in uitvoering:

- **3** kopieën van uw data bewaren (de originele data plus twee back-ups)
- **2** verschillende opslagmedia gebruiken (bijvoorbeeld interne schijf én externe schijf of tapesysteem)
- **1** kopie offsite bewaren (geografisch gescheiden van uw primaire locatie)

De kracht van deze regel zit in redundantie. Als één kopie verloren gaat door ransomware, hardware-uitval of brand, beschikt u altijd nog over minimaal twee andere kopieën. De offsite-kopie beschermt u specifiek tegen fysieke calamiteiten en tegen ransomware die zich door het netwerk verspreidt.
...
> **Tip van Control One:** Test uw back-upherstel minimaal elk kwartaal. Simuleer een volledig scenario: herstel een kritisch systeem volledig uit back-up en meet de hersteltijd (RTO). U ontdekt hiermee problemen voordat een incident dat voor u doet.
...
**RPO (Recovery Point Objective):** Hoeveel dataverlies accepteert u? Als uw RPO vier uur is, moet u minimaal elke vier uur een back-up maken.

**RTO (Recovery Time Objective):** Hoe snel moet u hersteld zijn? Als uw RTO acht uur is, moet uw herstelproces binnen die tijd uitvoerbaar zijn, inclusief verificatie.

Op basis van deze parameters kiest u uw back-upfrequentie, retentiebeleid en herstelmethode. Kritieke systemen verdienen een hogere frequentie en kortere hersteltime dan minder kritieke data.
...
- **Documenteer herstelprocedures** stap voor stap, zodat herstel uitvoerbaar is ook als uw hoofd-IT-er niet beschikbaar is.
...
Voor organisaties die ISO 27001 nastreven, is het back-upbeleid een van de eerste documenten die een auditor opvraagt. Zorg dat het beleid aansluit op uw daadwerkelijke praktijk — een papieren tiger is erger dan geen beleid, omdat het bij een incident aantoonbaar tekortschiet.
...
Afhankelijk van uw branche en uw RPO/RTO-definities. Een gangbare retentie is dagelijkse back-ups voor 30 dagen, wekelijkse voor 12 weken en maandelijkse voor 12 maanden.
...
Dit valt onder het "gedeelde verantwoordelijkheidsmodel." De cloudleverancier beschermt de infrastructuur; u bent verantwoordelijk voor het back-uppen van uw eigen data.

---

Wilt u uw back-upstrategie laten toetsen op volledigheid en aansluiting bij ISO 27001? Bekijk onze aanpak op [de prijzenpagina](/prijzen) en ontdek hoe Control One u helpt uw continuïteit te borgen.
