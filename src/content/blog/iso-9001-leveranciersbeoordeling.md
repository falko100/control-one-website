...
imageAlt: 'Leveranciersbeoordeling in ISO 9001 — Control One'
keywords:
  - 'ISO 9001 leveranciersbeoordeling'
  - 'leveranciersselectie QMS'
  - 'leveranciersaudit ISO 9001'
  - 'inkoopbeheer ISO 9001'
draft: false
---
...
ISO 9001:2015 clausule 8.4 onderscheidt drie vormen van extern geleverde processen, producten en diensten:

1. Producten en diensten die zijn ingekocht voor opname in de eigen producten of diensten
...
|---|---|
| Kwaliteitscertificering | Beschikt de leverancier over ISO 9001 of een vergelijkbaar certificaat? |
| Referenties en trackrecord | Aantoonbare ervaring in vergelijkbare toepassingen |
| Financiële stabiliteit | Is de leverancier een betrouwbare langetermijnpartner? |
...
> **Tip:** Maak een onderscheid tussen goedgekeurde leveranciers en preferred suppliers. Goedgekeurde leveranciers voldoen aan de minimale eisen; preferred suppliers presteren structureel bovengemiddeld en verdienen de voorkeur bij herhalingsinkoop.
...
- Kwaliteit van geleverde producten of diensten (percentage keuring afgekeurd)
- Leverbetrouwbaarheid (percentage leveringen op tijd en volledig)
- Communicatie en responsiviteit bij problemen
- Omgang met klachten en afwijkingen
- Prijs- en contractnaleving
...
- Leveringsvoorwaarden (verpakking, labeling, documenten)
- Eventuele certificeringseisen van de leverancier

Verificeer na ontvangst of het geleverde voldoet aan de specificaties. Registreer de uitkomst van de ontvangstkeuring als bewijs voor de externe audit.
