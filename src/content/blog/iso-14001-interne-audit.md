...
imageAlt: 'ISO 14001 interne audit: praktische handleiding — Control One'
keywords:
  - 'ISO 14001 interne audit'
  - 'milieuaudit'
  - 'EMS audit uitvoeren'
  - 'auditprogramma ISO 14001'
draft: false
---
...
- Alle clausules van ISO 14001 moeten binnen een bepaalde cyclus aan bod komen — doorgaans één jaar

Een jaarlijks auditprogramma kan er als volgt uitzien:
- **Q1**: Clausules 4 en 5 (context, leiderschap, milieubeleid)
- **Q2**: Clausules 6 en 7 (planning, ondersteuning)
- **Q3**: Clausule 8 (operationele beheersing, inclusief locatiebezoek)
- **Q4**: Clausules 9 en 10 (prestatie-evaluatie, verbetering) + managementreview voeding

> **Tip:** Plan de interne audit zo dat de bevindingen tijdig beschikbaar zijn voor de jaarlijkse **managementreview**. De directie heeft de auditresultaten nodig als input voor strategische beslissingen over het EMS. Een interne audit die pas ná de managementreview plaatsvindt, mist zijn doel.

## De auditor: eisen aan onafhankelijkheid en competentie

ISO 14001 stelt twee eisen aan de interne auditor:
1. **Onafhankelijkheid**: de auditor mag zijn eigen werk niet beoordelen
2. **Competentie**: de auditor dient aantoonbaar bekwaam te zijn

In de praktijk betekent dit dat een milieuveiligheidsmedewerker niet de processen auditet waarvoor hij/zij direct verantwoordelijk is, maar wel andere onderdelen van het EMS. Voor kleine organisaties — waar slechts één persoon verantwoordelijk is voor het EMS — kan het zinvol zijn een collega-auditor extern in te huren of deel te nemen aan een auditpool.

Competentie kan worden aangetoond door een opleiding tot interne auditor ISO 14001, aantoonbare kennis van de norm en van de processen die worden geauditeerd.

## Stap voor stap: de audit uitvoeren
...
- Combineer documentbeoordeling met interviews en fysieke observaties op de werkvloer
- Documenteer bevindingen feitelijk en onderbouwd — niet als persoonlijk oordeel maar als waarneming

**Rapportage**

| Bevindingstype | Definitie | Actie vereist |
|---|---|---|
| Conformiteit | Systeem functioneert conform de norm | Geen actie vereist |
| Observatie | Positief signaal of kans voor verbetering | Vrijwillige opvolging |
| Aanbeveling | Verbeterpunt zonder normovertreding | Geen verplichting maar gewenst |
| Afwijking | Niet-conformiteit met de norm of interne eis | Verplichte corrigerende maatregel |

**Opvolging**
Afwijkingen vereisen een corrigerende maatregel met een oorzaakanalyse, een actieplan en een geplande verificatiedatum. De opvolging is onderdeel van clausule 10.2.
