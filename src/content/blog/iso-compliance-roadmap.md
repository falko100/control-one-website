...
keywords:
  ...
  - 'ISO implementatie tijdlijn'
  - 'van nul naar ISO gecertificeerd'
draft: false
---
...
Voordat de klok begint te lopen, zijn er drie randvoorwaarden die bepalend zijn voor het slagen van het traject.

**Commitment van de directie.** ISO-normen vereisen aantoonbare betrokkenheid van het topmanagement. Dat is geen formaliteit: auditors controleren of de directie daadwerkelijk leiding geeft aan het managementsysteem. Zonder directiebesluit, toegewezen budget en regelmatige betrokkenheid loopt elk ISO-traject vast.
...
- Voer de gap-analyse uit (intern of met externe begeleiding)
...
| Document | Doel |
|---|---|
| Beleidsverklaring | Commitment van directie vastleggen |
| Scope-document | Afbakening van het managementsysteem |
| Contextanalyse (clausule 4) | Interne en externe factoren, stakeholders |
| Risicoregister | Geidentificeerde risico's en beheersmaatregelen |
| Procesdocumentatie | Beschrijving van kritische processen |
...
- Activeer het risicoregister en voer de eerste risicobeoordelingsronde uit
...
- Worden uitgevoerd door iemand die onafhankelijk is van het te auditeren proces
...
| Fase | Maand | Kernactiviteit |
|---|---|---|
| Nulmeting | 1–2 | Gap-analyse, projectplan, certificeerder selecteren |
| Documentatie | 3–4 | Beleid, procedures, risicoregister opbouwen |
| Implementatie | 5–6 | Training, records, beheersmaatregelen activeren |
| Interne audit | 7–8 | Auditcyclus uitvoeren, bevindingen documenteren |
| Correctie & verfijning | 9–10 | Maatregelen doorvoeren, stage 1-audit doorlopen |
| Externe audit | 11–12 | Stage 2-audit, certificering ontvangen |

---

Klaar om te starten? Control One begeleidt MKB-organisaties door het volledige traject — van gap-analyse tot het moment dat het certificaat in handen is. Bekijk onze pakketten en plan een oriëntatiegesprek op [de prijzenpagina](/prijzen).
