...
imageAlt: 'Risicomanagement met ISO 31000: praktische aanpak — Control One'
keywords:
...
## De drie lagen van ISO 31000

ISO 31000 is opgebouwd uit drie samenhangende lagen:

| Laag | Inhoud |
|---|---|
| Principes | Acht leidende principes voor effectief risicomanagement |
| Raamwerk | De organisatiestructuur die risicomanagement verankert |
| Proces | De stap-voor-stap aanpak voor identificatie, beoordeling en behandeling |

**De acht principes** zijn onder andere: risicomanagement creëert en beschermt waarde, is een integraal deel van organisatieprocessen, is gebaseerd op de best beschikbare informatie, en is dynamisch en reageert op veranderingen.

**Het raamwerk** omvat leiderschap en commitment, integratie in organisatieprocessen, ontwerp, implementatie, evaluatie en verbetering van het risicomanagementraamwerk. Het raamwerk beschrijft dus hoe risicomanagement als systeem functioneert.

**Het proces** is de operationele kern: communicatie en overleg, vaststellen van de context, risicobeoordeling (identificatie, analyse, evaluatie), risicobehandeling, monitoring en review, en registratie en rapportage.
...
Dat vereist een cultuur van openheid: medewerkers moeten risicos kunnen melden zonder angst voor repercussies. Een medewerker die een potentieel gevaar signaleert, doet de organisatie een dienst. Stimuleer dit gedrag actief en communiceer wat er met gemelde risicos is gedaan.

Maak risicomanagement bespreekbaar in reguliere vergaderingen, niet alleen in de jaarlijkse risicoanalyse. Zo wordt het onderdeel van de dagelijkse bedrijfsvoering in plaats van een jaarlijkse compliance-exercitie.
...
Voor een kleine organisatie met beperkte scope is een basisrisicoregister in twee tot vier dagdelen op te stellen. Voor een grotere organisatie met meerdere processen en normen kan dit oplopen tot meerdere weken. Een externe facilitator kan dit proces aanzienlijk versnellen.
