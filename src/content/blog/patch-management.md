...
description: '60% van inbraken benut bekende kwetsbaarheden. Zo bouwt je een werkend patch managementproces.'
...
Voor SaaS-diensten is de leverancier verantwoordelijk. Voor IaaS/PaaS bent je zelf verantwoordelijk voor het patchen van je besturingssystemen en applicaties. Maak dit onderscheid expliciet in je beleid.
...
Wil je je patch managementproces laten beoordelen of aansluiten op een ISO 27001-traject? Bekijk onze diensten op [de prijzenpagina](/prijzen) en ontdek hoe Control One je helpt van kwetsbaar naar aantoonbaar weerbaar.
