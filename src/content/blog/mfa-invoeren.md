---
title: 'Multi-factor authenticatie (MFA) invoeren: zo doe je het'
description: "MFA blokkeert 99% van geautomatiseerde aanvallen. Hoe implementeer je het organisatiebreed?"
...
2. **Iets wat je hebt** — telefoon, hardwaretoken, smartcard
3. **Iets wat je bent** — vingerafdruk, gezichtsherkenning
...
Documenteer je MFA-beleid — welke systemen vereisen MFA, welke methoden zijn toegestaan, hoe uitzonderingen worden beheerd — in je informatiebeveiligingsbeleid. Via het Control One platform kun je dit documenteren en bijhouden wie het beleid heeft gelezen en geaccepteerd. Meer weten? Bekijk de [prijzen](/prijzen).
...
MFA invoeren is een van de hoogste-rendement beveiligingsinvesteringen die je kunt doen — de impact is enorm, de kosten zijn minimaal. Klaar om ook je ISO 27001-compliance op orde te brengen? Ontdek hoe Control One je helpt op de [prijzenpagina](/prijzen).
